...
getStyle() returns the lamp style; isBattery return the value of battery; and getGlobRating() returns globRating of the lamp.
...
Also, six methods should be defined: make() has no return type and prints a message to the effect the bed is being made:
...
3. Create a class with name Celling. There are two member variables for this one, height and paintedColor, both of type int.
